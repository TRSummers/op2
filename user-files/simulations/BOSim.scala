...
class BOSim extends Simulation {
...
//****************************************************
        ...
        val scen_1 = scenario("Users_1").repeat(ITR,"x"){
                ...
                group("LOGIN"){
                    exec(
                                feed(NPIfeeder),
                                BOPages.LOGIN, BOPages.CommonPause,
                                BOPages.LOGGED_IN, BOPages.CommonPause,
                                BOPages.SEARCH, BOPages.CommonPause)
                        }
        }
       ...
       val scen_2 = scenario("Users_2").repeat(ITR,"x"){
              ...
              group("TIN"){
                    exec(
                                feed(TINfeeder),
                                BOPages.TIN, BOPages.CommonPause)
                        }
        }
        ...
        val scen_3 = scenario("Users_3").repeat(ITR,"x"){
                ...
                group("LName"){
                    exec(
                                feed(LNfeeder),
                                BOPages.LN, BOPages.CommonPause)
                        }
        }
