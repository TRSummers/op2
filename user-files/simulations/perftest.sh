...
apis(){
	...
	echo
	echo "=============================="
	read -p "Enter Simulation number: " scen
	...
	echo "=============================================================================================="
	echo 
	echo "Defaults that can be overridden are as follows:"
	echo
	echo "Number of iterations.............1"
	echo "Ramp up time.................... 5 (seconds)"
	echo "Number of users for $project: 1"
	...
	echo "4. Common Pause low threshold"
	echo "5. Common Pause high threshold"
	echo
	echo "=============================================================================================="
	read -p "Enter D (Defult) or O (Override): " var
  	...
  	case  $var  in
		...
		[O,o])
			...
			read -p 'Enter Ramp up time: ' ramp
			read -p 'Enter Commmon Pause Low: ' low
			read -p 'Enter Commmon Pause High: ' high
...
#		        while  [ $SIM_NUMBER -le 3 ]; do
                		...
                		read -p "Enter number of users for ${project}:" USERS
		...
		echo "Common Pause Low:	$low (seconds)"
		echo "Common Pause High:	$high (seconds)"
		echo
		...
		./gatling.sh -i$iterations -r$ramp -s$TOTAL_SIMULATIONS -x$SIMULATION_1 -y$SIMULATION_2 -z$SIMULATION_3 -n$SCENARIO -a$API -L$low -H$high
