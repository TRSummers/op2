...
class RecordedSimulation extends Simulation {
	...
	val scn = scenario("RecordedSimulation")
		.exec(http("request_0")
			...
			.headers(headers_65)
			.body(RawFileBody("/recordedsimulation/0065_request.json")),
            http("request_66")
			...
			.headers(headers_68)
			.body(RawFileBody("/recordedsimulation/0068_request.txt")),
            http("request_69")
			.post(uri09 + "/user/v1/graphql")
			.headers(headers_68)
			.body(RawFileBody("/recordedsimulation/0069_request.txt")),
            http("request_70")
			.post("/rootconfig")
			.headers(headers_70)
			.body(RawFileBody("/recordedsimulation/0070_request.json")),
            http("request_71")
			.post(uri09 + "/user/v1/graphql")
			.headers(headers_68)
			.body(RawFileBody("/recordedsimulation/0071_request.txt")),
            http("request_72")
			.post(uri07 + "/WRSiteInterceptEngine/Targeting.php?Q_ZoneID=ZN_elYUf0UpLzmy0bI&Q_CLIENTVERSION=1.59.0&Q_CLIENTTYPE=web")
			.headers(headers_60)
			...
			.headers(headers_9),
            http("request_76")
			.post(uri09 + "/auth/oauth/token")
			.headers(headers_76)
			.formParam("grant_type", "client_credentials")
			.formParam("client_id", "crisis_client")
			.formParam("client_secret", "oVzyCAgVEJc61jBtk93Q"),
            http("request_77")
			.options(uri09 + "/provnew/v1/graphql")
			.headers(headers_77),
            http("request_78")
			.options(uri09 + "/member-search/graphql")
			.headers(headers_77),
            http("request_79")
			.post(uri09 + "/provnew/v1/graphql")
			.headers(headers_79)
			.body(RawFileBody("/recordedsimulation/0079_request.json")),
            http("request_80")
			.post(uri09 + "/member-search/graphql")
			.headers(headers_80)
			.body(RawFileBody("/recordedsimulation/0080_request.json")),
            http("request_81")
			.get(uri08 + "?address=53+Ogrady+Rd++Marlborough,+MA+01752-7802&key=AIzaSyAdLczqmIB8mu9yYJvCbTXRSFItLNVdXz4")
			.headers(headers_81),
            http("request_82")
			.post(uri09 + "/provnew/v1/graphql")
			.headers(headers_79)
			.body(RawFileBody("/recordedsimulation/0082_request.json")),
            http("request_83")
			.post(uri09 + "/provnew/v1/graphql")
			.headers(headers_79)
			...
			.get(uri11)
			.headers(headers_76)
			.basicAuth("admin","rGbKzixPsMb0CgvBs1tu!")))
		.pause(529)
		.exec(http("request_86")
			.get(uri08 + "?address=6379+dellwood+drive+fridley,+Minnesota,+&key=AIzaSyAdLczqmIB8mu9yYJvCbTXRSFItLNVdXz4")
			.headers(headers_81)
			.resources(http("request_87")
			.post(uri09 + "/provnew/v1/graphql")
			.headers(headers_79)
			.body(RawFileBody("/recordedsimulation/0087_request.json")),
            http("request_88")
			.post(uri09 + "/provnew/v1/graphql")
			.headers(headers_79)
			.body(RawFileBody("/recordedsimulation/0088_request.json"))))
